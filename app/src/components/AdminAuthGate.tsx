    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: 12, padding: "40px 48px", maxWidth: 380, width: "100%",
          boxShadow: "var(--shadow)",
        }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            <span style={{ fontSize: 36 }}>🔒</span>
            <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, fontWeight: 400, marginTop: 12, marginBottom: 8 }}>
              Zone admin
            </h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            />
            {error && <p style={{ fontSize: 13, color: "#dc2626", marginTop: -8 }}>Mot de passe incorrect.</p>}
            <button
              type="submit"
              style={{
